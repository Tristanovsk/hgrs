...
class product():
    def __init__(self,
        ...
        self.spectral = Spectral(self.wl, self.fwhm,expon=expon)
...
class algo(product):
    ...
    def get_gaseous_transmittance(self):
        ...
        self.Tg_other = self.spectral.convolve2(Tg,name='Ttot')
...
class Spectral():
    def __init__(self,
        ...
        if not isinstance(fwhm, xr.DataArray):

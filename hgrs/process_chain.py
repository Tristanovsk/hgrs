...
for site in sites:
    ...
    odir = opj('/media/harmel/TOSHIBA EXT/acix-iii', site)  # /sat_data/satellite/acix-iii/results/',site)
    ...
    for l1c_path in glob.glob(opj(workdir, '*L1_STD_OFFL*.he5')):
        ...
        ofile = opj(odir, l1c.replace('.he5', '.nc').replace('L1_STD_OFFL', 'L2A_hGRS'))
